...
def declare_params(self):
    ...
    self.declare_parameter('rate', 2)  # 50

    self.declare_parameter('sensorstate_rate', 1)  # 10
    ...
    self.declare_parameter('joint_update_rate', 1)  # 10
    self.declare_parameter('base_controller_rate', 1)  # 10
...
def declare_json_params(self):
    self.declare_parameter('sensors', """{
                                "onboard_led": 
                                    {"pin": 13, "type": "Digital", "rate": 1, "direction": "output"}
                            }""")
